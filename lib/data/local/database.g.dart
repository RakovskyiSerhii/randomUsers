    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `UserEntity` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `firstName` TEXT NOT NULL, `lastName` TEXT NOT NULL, `email` TEXT NOT NULL, `icon` TEXT, `photo` TEXT)');
...
class _$UserDao extends UserDao {
  ...
  Future<void> updateUser(UserEntity entity) async {
    await _userEntityUpdateAdapter.update(entity, OnConflictStrategy.abort);
  }

  @override
  Future<int> deleteUsers(List<UserEntity> list) {
    return _userEntityDeletionAdapter.deleteListAndReturnChangedRows(list);
  }
}
